...
- [x] **FEAT-01**: 修复审计中发现的所有 P0 功能缺口
- [x] **FEAT-02**: 修复审计中发现的所有 P1 体验差异
- [x] **FEAT-03**: 确认底部导航、Toast 通知、主题切换行为与小程序一致
- [x] **FEAT-04**: 确认登录态管理（本地 demo）行为与小程序一致
- [ ] **FEAT-05**: 鸿蒙端添加"生成二维码"功能——会员可将 Token 导出为 otpauth QR 码，便于迁移到其他验证器
- [ ] **FEAT-06**: 鸿蒙端添加"复制密钥"功能——会员查看 Secret Key 后可一键复制到剪贴板（小程序同步跟进）
